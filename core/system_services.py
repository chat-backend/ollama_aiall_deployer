...
#!/usr/bin/env python3
"""
System services setup module for AIALL Gateway.
...
from config import EMAIL   # EMAIL được định nghĩa trong config.py
...
def install_ollama() -> None:
    ...
    if not is_linux():
        log("Non-Linux system detected — skipping Ollama install.")
        return
